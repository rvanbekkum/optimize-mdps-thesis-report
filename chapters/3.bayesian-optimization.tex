...
Finally, another relevant example is seen in \cite{wilson2014using} in which Bayesian Optimization is used to optimize policies for \acrshort{acr:rl} by exploiting generated trajectory data.
