...
\begin{figure}[t!]
	...
	\begin{subfigure}[t]{0.495\textwidth}
		...
		\label{fig:exp12}
	\end{subfigure}
	\caption{Plots showing a comparison of the resulting \acrshort{acr:gp} posterior for varying acquisition functions. The plots correspond to 20 iterations of the base framework on the \texttt{uol\_bl} environment with $\beta = 0.0$ and $k$-Means~clustering used.}
\end{figure}
