...
\begin{figure}[t]
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.495\textwidth}
		\includegraphics[width=\textwidth]{plots/tum_base/plot_b_00__alg_kmeans_pct_100_acq_ucb_maximum}
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.495\textwidth}
		\includegraphics[width=\textwidth]{plots/tum_base/plot_b_00__alg_kmeans_pct_100_acq_eips_maximum}
...
\begin{figure}[!t]
	...
	\begin{subfigure}[t]{0.495\textwidth}
		...
		\caption{Experiment 13: \acrshort{acr:mei} acquisition function used in first phase}
		\label{fig:exp13}
	\end{subfigure}
	\begin{subfigure}[t]{0.495\textwidth}
		\includegraphics[width=\textwidth]{plots/tum_multi/plot_b_00__alg_kmeans_pct_100_acq_ucb}
		\caption{Experiment 14: \acrshort{acr:gp-ucb} acquisition function used in first phase}
		\label{fig:exp14}
	\end{subfigure}
	...
	\begin{subfigure}[t]{0.495\textwidth}
		...
		\caption{Experiment 15: \acrshort{acr:mei} acquisition function used in first phase}
		\label{fig:exp15}
	\end{subfigure}
	\begin{subfigure}[t]{0.495\textwidth}
		\includegraphics[width=\textwidth]{plots/uol_multi/plot_b_00__alg_kmeans_pct_100_acq_ucb}
		\caption{Experiment 16: \acrshort{acr:gp-ucb} acquisition function used in first phase}
		\label{fig:exp16}
	\end{subfigure}
