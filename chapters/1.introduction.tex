...
\noindent This yields the following main research question for this thesis:
...
To answer this main research question, three research questions have been identified which are presented below.
...
\vspace{12pt}
\noindent\textbf{Research Question 3.} How can the hierarchy of different abstraction levels be exploited to find a performance-maximizing \acrshort{acr:mdp} in a more cost-effective way?
\vspace{12pt}
...
Therefore it might be value to investigate how this could be exploited to achieve a more cost-effective optimization of the performance.
