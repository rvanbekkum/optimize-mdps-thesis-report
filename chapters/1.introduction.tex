...
In numerous real-world settings, such as traffic light control, mobile robot navigation or decision-making in medical treatment, it is quite common to be faced with uncertainty about the effect of an action (possibly selected based on incomplete or faulty).
