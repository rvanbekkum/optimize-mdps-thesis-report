...
Although, when the state space of \acrshortpl{acr:pomdp} is not learned from the available data, employing the Baum-Welch algorithm is probably a more attractive alternative, considering the state merging algorithms are computationally quite expensive.
