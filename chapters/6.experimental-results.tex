...
\begin{table}[pt]
	\caption{Details about the gathered datasets which consist of execution traces of the SCITOS-A5 robot in various Morse simulation environments.}
	\label{tab:datasets-environments}\centering
	\begin{tabular}{|l|r|r|}
	\hline
	\textbf{Environment Name} & \textbf{Area} & \textbf{Number of Entries in Dataset} \\
	\hline
	\texttt{tum\_kitchen}& $7 \times 10 = \SI{70}{\metre\squared}$              &   $4370$                                    \\
	\hline
	\texttt{uol\_bl}& $36 \times 26 = \SI{936}{\metre\squared}$               & $10007$           						\\ \hline          
	\end{tabular}
\end{table}
...
For the implementation of the framework for this domain we make use of the \acrshort{acr:bo} framework for optimization.
...
\begin{table}
	\caption{Details on the different configurations used for the experiments.}
	\label{tab:configurations}\centering
	\begin{tabular}{|l|l|r|l|l|r|}
		...
		\hline
		4 & \texttt{tum\_kitchen} & 0.0 & \acrshort{acr:mei} & \acrshort{acr:gmm} & 100\% \\
		\hline
		5 & \texttt{tum\_kitchen} & 0.0 & \acrshort{acr:gp-ucb} & $k$-Means & 100\% \\
		\hline
		6 & \texttt{tum\_kitchen} & 0.0 & \acrshort{acr:gp-ucb} & \acrshort{acr:gmm} & 100\% \\
		\hline
		7 & \texttt{tum\_kitchen} & 0.25 & \acrshort{acr:mei} & $k$-Means & 100\% \\
		\hline
		8 & \texttt{tum\_kitchen} & 0.50 & \acrshort{acr:mei} & $k$-Means & 100\% \\
		\hline
		9 & \texttt{uol\_bl} & 0.0 & \acrshort{acr:mei} & $k$-Means & 100\% \\
		\hline
		...
		\hline
		13 & \texttt{uol\_bl} & 0.0 & \acrshort{acr:gp-ucb} & $k$-Means & 100\% \\
		\hline
